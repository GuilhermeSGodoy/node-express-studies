# Atividade 2: Sugestões de Melhorias em Código Backend

Esta atividade tem como propósito apresentar sugestões de melhorias para o código da aplicação diposto acima. A organização baseia-se na ideia de apresentar subtítulos com o tópico que está sendo apontado na sugestão e os arquivos citados estão distribuídos em tópicos, com links para acessá-los diretamente.
